# JWT (original: https://github.com/lcobucci/jwt)
...
```shell
composer require maximumtest/jwt
```
...
use Maximumtest\JWT\Builder;
use Maximumtest\JWT\Signer\Key;
use Maximumtest\JWT\Signer\Rsa\Sha256; // you can use Maximumtest\JWT\Signer\Ecdsa\Sha256 if you're using ECDSA keys
