...
use Maximumtest\JWT\Claim\Factory as ClaimFactory;
use Maximumtest\JWT\Parsing\Encoder;
...
class BuilderTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @test
     *
     * @covers Maximumtest\JWT\Builder::__construct
     */
     ...
     * @test
     *
     * @uses Maximumtest\JWT\Builder::__construct
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::permittedFor
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::expiresAt
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::identifiedBy
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::issuedAt
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::issuedBy
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::canOnlyBeUsedAfter
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::withClaim
     *
     * @covers Maximumtest\JWT\Builder::relatedTo
     * @covers Maximumtest\JWT\Builder::setRegisteredClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::__construct
     *
     * @covers Maximumtest\JWT\Builder::withClaim
     */
     ...
     * @uses Maximumtest\JWT\Builder::__construct
     *
     * @covers Maximumtest\JWT\Builder::withHeader
     */
     ...
     *
     * @uses Maximumtest\JWT\Builder::__construct
     * @uses Maximumtest\JWT\Builder::getToken
     * @uses Maximumtest\JWT\Token
     *
     * @covers Maximumtest\JWT\Builder::sign
     */
     ...
     *
     * @covers Maximumtest\JWT\Builder::unsign
     */
     ...
     * @uses Maximumtest\JWT\Token
     *
     * @covers Maximumtest\JWT\Builder::getToken
     */
