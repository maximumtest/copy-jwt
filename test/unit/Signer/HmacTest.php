...
class HmacTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers Maximumtest\JWT\Signer\Hmac::createHash
     */
     ...
     *
     * @uses Maximumtest\JWT\Signer\Hmac::createHash
     * @uses Maximumtest\JWT\Signer\Key
     *
     * @covers Maximumtest\JWT\Signer\Hmac::doVerify
     */
     ...
     * @test
     *
     * @covers Maximumtest\JWT\Signer\Hmac::hashEquals
     */
