...
final class RsaTest extends TestCase
{
     ...
     * @test
     *
     * @covers \Maximumtest\JWT\Signer\Rsa::createHash
     * @covers \Maximumtest\JWT\Signer\Rsa::validateKey
     * @covers \Maximumtest\JWT\Signer\Rsa::getKeyType
...
KEY;
     ...
     * @test
     *
     * @covers \Maximumtest\JWT\Signer\Rsa::doVerify
     * @covers \Maximumtest\JWT\Signer\Rsa::validateKey
     * @covers \Maximumtest\JWT\Signer\Rsa::getKeyType
     * @covers \Maximumtest\JWT\Signer\OpenSSL
     * @covers \Maximumtest\JWT\Signer\BaseSigner
